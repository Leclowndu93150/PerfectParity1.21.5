package com.leclowndu93150.perfectparity.entity.models.pig;
...
public class ModPigModel<T extends Entity> extends QuadrupedModel<T> {
    ...
    // Make this public so ColdPigModel can access it
    public static MeshDefinition createBasePigModel() {
