...
import com.leclowndu93150.perfectparity.sound.AmbientDesertBlockSoundsPlayer;
...
public class TallDryGrassBlock extends DryVegetationBlock implements ModBonemealableBlock {
    ...
    public boolean isValidBonemealTarget(LevelReader levelReader, BlockPos blockPos, BlockState blockState) {
        return ModBonemealableBlock.hasSpreadableNeighbourPos(levelReader, blockPos, ModBlocks.SHORT_DRY_GRASS.get().defaultBlockState());
    }
    ...
    public void performBonemeal(ServerLevel serverLevel, RandomSource randomSource, BlockPos blockPos, BlockState blockState) {
        ModBonemealableBlock.findSpreadableNeighbourPos(serverLevel, blockPos, ModBlocks.SHORT_DRY_GRASS.get().defaultBlockState()).ifPresent((blockPosx) -> serverLevel.setBlockAndUpdate(blockPosx, ModBlocks.SHORT_DRY_GRASS.get().defaultBlockState()));
    }
